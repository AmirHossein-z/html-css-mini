...
function ClassPlaceholder({
  ...
  return (
    <>
      <td
        className="relative top-0 p-8 text-sm bg-white border-b border-gray-200"
        onMouseOver={() => setShowBtns(true)}
        onMouseLeave={() => setShowBtns(false)}
      >
        <ClassContent content={classTime.content} type={classTime.type} />
        {showBtns && (
          <div className="absolute top-[30%] left-[5%] flex gap-2 justify-center animate-fade_in_from_bottom">
            <button
              type="button"
